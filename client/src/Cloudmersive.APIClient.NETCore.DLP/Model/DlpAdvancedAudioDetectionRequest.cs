...
namespace Cloudmersive.APIClient.NETCore.DLP.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DlpAdvancedAudioDetectionRequest :  IEquatable<DlpAdvancedAudioDetectionRequest>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DlpAdvancedAudioDetectionRequest);
        }

        /// <summary>
        /// Returns true if DlpAdvancedAudioDetectionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DlpAdvancedAudioDetectionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DlpAdvancedAudioDetectionRequest input)
        {
            if (input == null)
                return false;
