...
namespace Cloudmersive.APIClient.NETCore.DLP.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DlpAdvancedDetectionResponse :  IEquatable<DlpAdvancedDetectionResponse>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DlpAdvancedDetectionResponse);
        }

        /// <summary>
        /// Returns true if DlpAdvancedDetectionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DlpAdvancedDetectionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DlpAdvancedDetectionResponse input)
        {
            if (input == null)
                return false;
