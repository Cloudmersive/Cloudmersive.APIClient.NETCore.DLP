...
namespace Cloudmersive.APIClient.NETCore.DLP.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DlpAudioDetectionResponse :  IEquatable<DlpAudioDetectionResponse>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DlpAudioDetectionResponse);
        }

        /// <summary>
        /// Returns true if DlpAudioDetectionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DlpAudioDetectionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DlpAudioDetectionResponse input)
        {
            if (input == null)
                return false;
