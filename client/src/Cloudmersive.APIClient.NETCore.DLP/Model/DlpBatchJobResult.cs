...
namespace Cloudmersive.APIClient.NETCore.DLP.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DlpBatchJobResult :  IEquatable<DlpBatchJobResult>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DlpBatchJobResult);
        }

        /// <summary>
        /// Returns true if DlpBatchJobResult instances are equal
        /// </summary>
        /// <param name="input">Instance of DlpBatchJobResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DlpBatchJobResult input)
        {
            if (input == null)
                return false;
