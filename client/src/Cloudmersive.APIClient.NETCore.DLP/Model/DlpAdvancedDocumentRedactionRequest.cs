...
namespace Cloudmersive.APIClient.NETCore.DLP.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DlpAdvancedDocumentRedactionRequest :  IEquatable<DlpAdvancedDocumentRedactionRequest>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DlpAdvancedDocumentRedactionRequest);
        }

        /// <summary>
        /// Returns true if DlpAdvancedDocumentRedactionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DlpAdvancedDocumentRedactionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DlpAdvancedDocumentRedactionRequest input)
        {
            if (input == null)
                return false;
