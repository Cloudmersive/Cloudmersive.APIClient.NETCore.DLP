...
namespace Cloudmersive.APIClient.NETCore.DLP.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DlpRedactionResponse :  IEquatable<DlpRedactionResponse>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DlpRedactionResponse);
        }

        /// <summary>
        /// Returns true if DlpRedactionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DlpRedactionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DlpRedactionResponse input)
        {
            if (input == null)
                return false;
