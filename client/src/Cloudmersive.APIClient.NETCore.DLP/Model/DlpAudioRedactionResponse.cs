...
namespace Cloudmersive.APIClient.NETCore.DLP.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DlpAudioRedactionResponse :  IEquatable<DlpAudioRedactionResponse>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DlpAudioRedactionResponse);
        }

        /// <summary>
        /// Returns true if DlpAudioRedactionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DlpAudioRedactionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DlpAudioRedactionResponse input)
        {
            if (input == null)
                return false;
