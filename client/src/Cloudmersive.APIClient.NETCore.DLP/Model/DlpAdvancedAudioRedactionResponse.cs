...
namespace Cloudmersive.APIClient.NETCore.DLP.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DlpAdvancedAudioRedactionResponse :  IEquatable<DlpAdvancedAudioRedactionResponse>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DlpAdvancedAudioRedactionResponse);
        }

        /// <summary>
        /// Returns true if DlpAdvancedAudioRedactionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DlpAdvancedAudioRedactionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DlpAdvancedAudioRedactionResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.RedactedAudio == input.RedactedAudio ||
                    (this.RedactedAudio != null &&
                    this.RedactedAudio.Equals(input.RedactedAudio))
                ) && 
                (
                    this.RedactedTranscript == input.RedactedTranscript ||
                    (this.RedactedTranscript != null &&
                    this.RedactedTranscript.Equals(input.RedactedTranscript))
                ) && 
                (
                    this.OriginalTranscript == input.OriginalTranscript ||
                    (this.OriginalTranscript != null &&
                    this.OriginalTranscript.Equals(input.OriginalTranscript))
                ) && 
                (
                ...
                (
                    this.RedactedSegments == input.RedactedSegments ||
                    this.RedactedSegments != null &&
                    this.RedactedSegments.SequenceEqual(input.RedactedSegments)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.RedactedAudio != null)
                    hashCode = hashCode * 59 + this.RedactedAudio.GetHashCode();
                if (this.RedactedTranscript != null)
                    hashCode = hashCode * 59 + this.RedactedTranscript.GetHashCode();
                if (this.OriginalTranscript != null)
                    hashCode = hashCode * 59 + this.OriginalTranscript.GetHashCode();
                if (this.Timestamps != null)
                    hashCode = hashCode * 59 + this.Timestamps.GetHashCode();
                if (this.RedactedSegments != null)
                    hashCode = hashCode * 59 + this.RedactedSegments.GetHashCode();
